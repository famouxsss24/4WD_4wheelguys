...
# ==========================================
# (best.pt) 경로입니다.
best_model_path = 'vision/runs/detect/4WD_Final_Project/train_data_0516/weights/best.pt'
model = YOLO(best_model_path)

# ==========================================
# 📝 2. 실전 테스트(수능) 설정 및 실행
# ==========================================
yaml_path = '/Users/gwonchangbin/univ/2-1/임베디드인공지능최적화/4WD_4wheelguys/vision/Final_Datasetv4/data.yaml'
